              ...
              <CardContent className="pt-6">
                ...
                <div className="bg-muted rounded-2xl p-4 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-foreground">₹{item.avgCampusPrice?.toFixed(2) || "N/A"}</span>
                  </div>
                  <p className="text-xs text-muted-foreground mt-2">{item.priceExplanation}</p>
                </div>
                ...
                <Link href={`/profile/${item.seller.id}`}>
                  <div className="flex items-center space-x-4 hover:bg-accent p-2 rounded-2xl -m-2 transition-colors">
                    <Avatar className="h-16 w-16">
                      <AvatarFallback className="text-lg bg-orange-500/20 text-orange-500">
                        {item.seller.name.charAt(0)}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1">
                      <div className="flex items-center">
                        <span className="font-semibold text-lg text-foreground">{item.seller.name}</span>
                      ...
                      {item.seller.college && (
                        <p className="text-sm text-muted-foreground">{item.seller.college}</p>
                      )}
